...
<title>FoodMap | Notice Edit and Delete</title>
	...
	<div class="body">
		...
		<div role="main" class="main">
			...
			<div class="container">
				...
				${dto.filename} &nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="fileDel" value="1"> Delete this file<br>
															</c:if>
												...
												<div class="form-group">
													<div align="right">
														...
														<button type="button" class="btn btn-Info"
															onclick="location.href='${path}/notice/notice_list.do';">List</button>
														<input type="button" class="btn btn-secondary"
															value="Delete" id="btnDelete"> <input
															type="button" class="btn btn-primary" value="Update"
															id="btnUpdate">
