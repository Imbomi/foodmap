...
<title>FoodMap | survey has been completed</title>
			...
			<div class="container py-2">
				...
				<div class="row">
					<div class="col">
						...
						<div class="row">
							<div class="col pb-3">
								<h1>Survey has been completed.</h1>
								<h2>Thank you for your time !</h2>

								<div>
									<input type="button" value="To Main"
										class="btn btn-primary float-center"
										onclick="location.href='${path}/main/main.do';"> 
										<input
										type="button" value="Go to Event"
										class="btn btn-success float-center"
										onclick="location.href='${path}/survey/survey_event.do';">
								</div>
